          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="relative">
              <div className="w-72 h-72 mx-auto relative">
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full animate-spin-slow opacity-50 blur-xl" />
                <div className="absolute inset-2 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full p-1">
                  <img src="https://i.ibb.co/2Y6dn8V3/Zishan-Deshmukh.png" alt="Zishan" className="w-full h-full rounded-full object-cover" />
                </div>
              </div>
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-6">
              ...
              <div className="flex gap-4 pt-4">
                <a href="https://github.com/zishandeshmukh" target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-slate-800 rounded-lg text-white font-medium hover:bg-slate-700 transition-colors flex items-center gap-2">
                ...
                <a href="https://linkedin.com/in/zishandeshmukh" target="_blank" rel="noopener noreferrer" className="px-6 py-3 bg-blue-600 rounded-lg text-white font-medium hover:bg-blue-700 transition-colors flex items-center gap-2">
